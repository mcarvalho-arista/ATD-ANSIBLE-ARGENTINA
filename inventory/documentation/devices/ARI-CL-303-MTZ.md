...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_oh1xar1esxc0201_Ethernet1 | trunk | 150,177 | - | - | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_ARI-SP-301-MTZ_Ethernet4 | - | 10.110.8.25/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_ARI-SP-302-MTZ_Ethernet4 | - | 10.110.8.27/31 | default | 9214 | False | - | - |
...
!
interface Ethernet2
   description P2P_ARI-SP-301-MTZ_Ethernet4
   no shutdown
   mtu 9214
   speed forced 100g
   no switchport
...
!
interface Ethernet3
   description P2P_ARI-SP-302-MTZ_Ethernet4
   no shutdown
   mtu 9214
   speed forced 100g
   no switchport
...
!
interface Ethernet4
   description SERVER_oh1xar1esxc0201_Ethernet1
   no shutdown
   speed 25g
